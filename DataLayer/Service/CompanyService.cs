            ...
            try
            {
                using (var connection = ADO.GetConnection())
                {
                    ...
                    using (var cmd = new SqlCommand(procedureName, connection))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@IN_INACTIVE", company.IS_INACTIVE);
                        ...
                        using (var reader = cmd.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                CompanyUpdate company = new CompanyUpdate
                                {
                                    ...
                                    IS_INACTIVE = reader["IN_INACTIVE"] != DBNull.Value ? Convert.ToBoolean(reader["IN_INACTIVE"]) : false
                                };
            ...
            try
            {
                using (var connection = ADO.GetConnection())
                {
                    ...
                    using (var cmd = new SqlCommand("SP_TB_COMPANY_MASTER", connection))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@IN_INACTIVE", DBNull.Value);
