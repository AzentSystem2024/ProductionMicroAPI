...
{
    public class MiscPayment_GSTService:IMiscPayment_GSTService
    {
        public MiscpaymentGSTResponse Save(MiscPayment_GST model)
        {
            ...
            try
            {
                using (SqlConnection connection = ADO.GetConnection())
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_MISC_PAYMENT_GST", connection))
                    {
                        ...
                        SqlParameter tvpParam = cmd.Parameters.AddWithValue("@UDT_TB_AC_PAYMENT_GST", dt);
                        tvpParam.SqlDbType = SqlDbType.Structured;
                        tvpParam.TypeName = "UDT_TB_AC_PAYMENT_GST";
        ...
        public MiscpaymentGSTResponse Edit(MiscPayment_GSTUpdate model)
        {
            MiscpaymentGSTResponse response = new MiscpaymentGSTResponse();
        ...
        public MiscPaymentListGSTResponse GetMiscPaymentList()
        {
            MiscPaymentListGSTResponse response = new MiscPaymentListGSTResponse
            {
                flag = 0,
                Message = "Failed",
                Data = new List<MiscPaymentListGSTItem>()
            };
            ...
            try
            {
                using (SqlConnection conn = ADO.GetConnection())
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_MISC_PAYMENT_GST", conn))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        using (SqlDataReader reader = cmd.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                response.Data.Add(new MiscPaymentListGSTItem
                                {
        ...
        public MiscPaymentGSTSelectedView GetMiscPaymentById(int id)
        {
            ...
            try
            {
                using (SqlConnection con = ADO.GetConnection())
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_MISC_PAYMENT_GST", con))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        using (SqlDataReader reader = cmd.ExecuteReader())
                        {
                            MiscPaymentGSTSelect header = null;

                            while (reader.Read())
                            {
                                if (header == null)
                                {
                                    header = new MiscPaymentGSTSelect
                                    {
                                        ...
                                        VAT_REGN = reader["VAT_REGN"] != DBNull.Value ? Convert.ToString(reader["VAT_REGN"]) : null,
                                        DEPT_ID = reader["DEPT_ID"] != DBNull.Value ? Convert.ToInt32(reader["DEPT_ID"]) : 0,
                                        DetailList = new List<MiscPaymentGSTDetail>()
                                    };
                                }

                                // Add detail row
                                header.DetailList.Add(new MiscPaymentGSTDetail
                                {
        ...
        public MiscpaymentGSTResponse Delete(int id)
        {
            ...
            try
            {
                using (var connection = ADO.GetConnection())
                {
                    ...
                    string procedureName = "SP_MISC_PAYMENT_GST";
