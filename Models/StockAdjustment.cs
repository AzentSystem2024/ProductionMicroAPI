namespace MicroApi.Models
{
    ...
    public class StockAdjustmentListResponse
    {
        ...
        public string Message { get; set; }
        public List<StockAdjustmentUpdate> Data { get; set; }
    }
    ...
    public class StockAdjustmentSettingsList
    {
        public int? ID { get; set; }
        public int? COMPANY_ID { get; set; }
        public int? STORE_ID { get; set; }
    ...
    public class StockAdjustmentSettingsListResponse
    {
        public int Flag { get; set; }
        public string Message { get; set; }
        public List<StockAdjustmentSettingsList> Data { get; set; }
    }
